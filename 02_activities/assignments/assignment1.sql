...
CASE WHEN product_qty_type = 'unit' THEN 'unit'
	WHEN product_qty_type is NULL THEN NULL --there are some NULL values, shoudn't be count as 'bulk'
	ELSE 'bulk'
...
DROP TABLE IF EXISTS temp.new_vendor; --check if temp.new_vendor exists and delete it is positive

CREATE TABLE temp.new_vendor AS  --create a temp table
SELECT * FROM vendor;

--Insert a new row to the temp.new_vendor table 
